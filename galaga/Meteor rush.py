        ...
        for meteor in meteors:
            ...
            if (
                ...
                if invulnerability_cooldown == 0:
                    ...
                    if lives == 0:
                        game_over = True  # Game over when lives reach 0
                    else:
...
while game_over:
    ...
    result_text = font.render(f"Score: {score} Lives: {lives}", True, (255, 255, 255))
    ...
    screen.blit(play_again_text, (width // 2 - play_again_text.get_width() // 2, height // 1.5))
    screen.blit(exit_text, (width // 2 - exit_text.get_width() // 2, height // 1.3))
